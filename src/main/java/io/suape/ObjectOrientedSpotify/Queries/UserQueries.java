...
public class UserQueries {
    ...
    public static final String INSERT_USER_QUERY = "INSERT INTO Users(userId, firstName, last_name, email, password) VALUES (:userId, :firstName, :lastName, :email, :password)";
